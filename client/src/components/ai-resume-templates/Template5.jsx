    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#fef3c7" }}>
      ...
      <div style={{ display: "flex" }}>
        ...
        <div style={{ flexGrow: 1, padding: "1rem", marginLeft: "10rem", marginRight: "8rem", marginTop: "4rem" }} className="md:ml-72 mt-16 md:mt-0">
          <div
            ref={resumeRef}
            style={{ maxWidth: "100%", width: "95%", margin: "1.25rem auto", padding: "1.5rem", backgroundColor: "#f9fafb", border: "1px solid #e5e7eb", borderRadius: "0.5rem", boxShadow: "0 25px 50px rgba(0,0,0,0.25)", ...resumeBodyStyle }}
