...
const UserResumePreview = forwardRef(
  ({ data, themeColor, zoomLevel, resumeBodyStyle  }, ref) => {
          ...
          <div className="max-w-7xl mx-auto">
            <div className="w-full mt-8">
              ...
              <div hidden={isEditing}>
                <UserResumePreview ref={resumeRef} data={resumeData} themeColor="indigo" zoomLevel={1} resumeBodyStyle={resumeBodyStyle}/>
              </div>
            </div>
